 ...
 */
$(function () {
	console.log('Created by Dmitry Siver on 1/19/2015');

	var mapDiv = $('#pripyatMap'),
		defaultScale = 1,
...
//	mapDiv.mousewheel(function (event, delta) {
//		if (delta > 0) {
//			currentScale += 0.1;
//		} else {
//			currentScale -= 0.1;
...
//		$("#" + renderer.getElementId()).bind('dragstart', function(e) { e.preventDefault(); });
	...
	MouseZoom.prototype.zoom = function(){
		...
		// new scale
		var newScale = previousScale + this.delta/2;
		// scale limits
		var maxscale = 20;
		if(newScale<1){
			newScale = 1;
	...
	var renderer = new ZoomPanRenderer("pripyatMap");
});